problemas_digestivos = {
    "Dipsia": {
        "causa": "Helicobacter Pylori: Bacteria que se encuentra en el agua o alimentos contaminados y coloniza el estómago.",
        "medicacion": {
            "medicamento": "Inhibidor de bomba de protones: Omeprazol, Esomeprazol, Lansoprazol (cualquiera de los tres, pertenecen a la misma familia)",
            "tiempo_med": "15 días",
            "dosis": {
                "Bebé/Niño": "7.7mg",
                "Adulto/Adulto Mayor": "20mg"
            }
        },
        "dieta": {
            "debe_comer": "Carnes Blancas (Pollo o Pescado), Bebidas calientes (Té), Carbohidratos (Arroz, Papas, Vegetales cocinados)",
            "no_debe_comer": "Cola, Café, Alimentos Procesados (empacados al vacío y conservantes)"
        },
        "recomendacion": "Acudir al médico."
    },
    "Reflujo": {
        "causa": "Helicobacter Pylori: Bacteria que se encuentra en el agua o alimentos contaminados y coloniza el estómago.",
        "medicacion": {
    ...
    "Gastroenteritis": {
            "causa": "Intoxicación alimenticia.",
            "medicacion": {
                "medicamento": "Sales de rehidratación oral: Suero oral, Proquinéticos: Trimebutina-Acto Basilis (Ayuda a reducir el reflujo y ayuda a la digestión)",
                "tiempo_med": "No especificado",
                "dosis": {
                    "Bebé/Niño": "No especificado",
                    "Adulto/Adulto Mayor": "No especificado"
                }
            },
            "dieta": {
                "debe_comer": "Mucho líquido",
                "no_debe_comer": "Cítricos, Picantes, Alimentos concentrados, Dulces, Procesados"
            },
            "recomendacion": "Acudir al médico."
        },
    "Gastroparesia": {
        "causa": "Alteración funcional del estómago.",
        "medicacion": {
            "medicamento": "Sales de rehidratación oral: Proquinéticos: Trimebutina-Acto Basilis (Ayuda a reducir el reflujo y ayuda a la digestión)",
            "tiempo_med": "No especificado",
            "dosis": {
                "Bebé/Niño": "No especificado",
                "Adulto/Adulto Mayor": "No especificado"
        ...
        "dieta": {
            "debe_comer": "Mucho líquido",
            "no_debe_comer": "Alimentos difíciles de digerir, Carnes rojas, Procesados, Condimentados, Alimentos concentrados"
        },
        "recomendacion": "Acudir al médico."
    },
    "Nauseas y Vomito": {
        ...
        "dieta": {
            "debe_comer": "Mucho líquido",
            "no_debe_comer": "Condimentados, Picante, Carbohidratos simples (Arroz y Papas), Carnes Blancas (Pollo, Pescado)"
        },
        "recomendacion": "Acudir al médico."
    }
}
...
preguntas_frecuentes = {
    ...
    "Tu Plan Fitness y Control de Peso": {
        "preguntas": [
            {
    ...
    "Nutrición Ideal para la Tercera Edad": {
        "preguntas": [
            {
    ...
    "Comidas Saludables para un Estilo de Vida Equilibrado": {
        "preguntas": [
            {
    ...
    "Alimentos a Evitar: Cuida tu Salud": {
        "preguntas": [
            {
